  ...
  const features = [
    {
      ...
      description: "Executes tasks, automates workflows, and collaborates with other agents—without prompts, setup, or interruptions.",
    ...
    },
    {
      ...
      description: 'Runs quietly in the background—no pop-ups, no distractions, just pure productivity.',
      color: 'from-orange-500 to-red-500'
    },
    {
      icon: Shield,
      title: 'On-Device Privacy',
      description: 'Everything runs on your machine—no data leaves your system, ensuring maximum privacy and control.',
